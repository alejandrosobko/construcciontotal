...
export const servicesData: Service[] = [
  {
    ...
    description: "Casas familiares, duplex y locales con los más altos estándares de calidad.",
    fullDescription:
    ...
    image: "/construccion-logo.jpg",
    seoTitle: "Construcción Residencial Profesional | Casas y Condominios de Calidad",
    seoDescription:
      "Especialistas en construcción residencial. Casas unifamiliares, duplex y condominios con materiales premium.",
    seoKeywords: ["construcción residencial", "casas construcción", "condominios", "viviendas de calidad"],
  },
  {
    id: "2",
    slug: "herreria",
    icon: Hammer,
    title: "Herrería",
    description: "Rejas, portones, estructuras y trabajos metálicos a medida con terminaciones profesionales.",
    fullDescription:
    ...
    seoKeywords: ["herrería", "portones", "rejas", "estructuras metálicas", "trabajos metálicos"],
  },
  {
    id: "3",
    slug: "electricidad",
    icon: Zap,
    title: "Electricidad",
    description: "Instalaciones, reparaciones y mantenimiento eléctrico para hogares y comercios.",
    fullDescription:
    ...
    seoTitle: "Electricidad Domiciliaria y Comercial | Instalaciones y Reparaciones",
    seoDescription:
    ...
    seoKeywords: ["electricidad", "electricista", "instalaciones eléctricas", "tableros", "reparaciones eléctricas"],
  },
  {
    id: "4",
    slug: "refrigeracion",
    ...
    description: "Instalación, mantenimiento y carga de gas para equipos de aire acondicionado.",
    fullDescription:
    ...
    seoKeywords: ["aire acondicionado", "refrigeración", "carga de gas", "instalación de split", "mantenimiento de aire"],
  },
]
